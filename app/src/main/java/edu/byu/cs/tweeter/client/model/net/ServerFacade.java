...
public class ServerFacade {
    ...
    public GetUserResponse getUser(Map<String, String> headers, String urlPath) throws IOException, TweeterRemoteException {
        return clientCommunicator.doGet(urlPath, headers, GetUserResponse.class);
    }
